function firstAttack(enemy,ai,event,data)
    if (event == 0) then --
		...
		if ai.GetTargetUnit() ~= nil then
			...
			for i = 1, 10 do
				ai.UseSkill(math.random(34, 35), Point(x *  math.cos(t + math.rad(i *  math.random(26, 46))), y * math.sin(t + math.rad(i *  math.random(26, 46))) ))
			end
			ai.UseSkill(36)
...
Server.SetMonsterAI(71, firstAttack)
